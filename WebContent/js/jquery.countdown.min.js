...
(function($) {
    function Countdown() {
        this.regional = [];
        this.regional[''] = {
            labels: ['Years', 'Months', '', '<a id="request1" style="font-size:25px;font-weight:bold;">多</a>', '<a id="request2" style="font-size:25px;font-weight:bold;" >快</a>', '<a id="request3" style="font-size:25px;font-weight:bold;">好</a>', '<a id="request4" style="font-size:25px;font-weight:bold;">省</a>'],
    ...
    $.extend(Countdown.prototype, {
        ...
        _generateHTML: function(c) {
            ...
            var n = function(a) {
                ...
                return (f[a] ? '<span class="countdown_section"><span class="countdown_amount">' + periods[a] + '</span><br/>' + (b ? b[a] : j[a]) + '</span>': '')
            };
            return (i ? this._buildLayout(c, f, i, h) : ((h ? '<span class="countdown_row countdown_amount' + (c._hold ? ' countdown_holding': '') + '">' + m(Y) + m(O) + m(W) + m(D) + (f[H] ? this._minDigits(periods[H], 2) : '') + (f[M] ? (f[H] ? k: '') + this._minDigits(periods[M], 2) : '') + (f[S] ? (f[H] || f[M] ? k: '') + this._minDigits(periods[S], 2) : '') : '<span class="countdown_row countdown_show' + e + (c._hold ? ' countdown_holding': '') + '">' + n(Y) + n(O) + n(W) + n(D) + n(H) + n(M) + n(S)) + '</span>' + (l ? '<span class="countdown_row countdown_descr">' + l + '</span>': '')))
        },
