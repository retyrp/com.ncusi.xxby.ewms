...
public class EmailSend {
	...
	public static String myEmailAccount = "1689923603@qq.com";// 发件人记得用QQ
	public static String myEmailPassword = "ezunbnutruuafddg";
	...
	// 收件人邮箱（替换为自己知道的有效邮箱）
	public static String receiveMailAccount = "1101131319@qq.com";

	public static void sendMail(String c, String rec) throws Exception {
		// 1. 创建参数配置, 用于连接邮件服务器的参数配置
		setReceiveMailAccount(rec);
		...
		// 3. 创建一封邮件
		MimeMessage message = createMimeMessage(c, session, myEmailAccount, receiveMailAccount);
	...
	public static void setReceiveMailAccount(String receiveMail) {
	 ...
	 * @throws Exception
	 */
	public static MimeMessage createMimeMessage(String s, Session session, String sendMail, String receiveMail)
			throws Exception {
		// 1. 创建一封邮件
		MimeMessage message = new MimeMessage(session);

		// 2. From: 发件人
		message.setFrom(new InternetAddress(sendMail, "电子仓储管理系统", "UTF-8"));

		// 3. To: 收件人（可以增加多个收件人、抄送、密送）
		message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "用户", "UTF-8"));

		// 4. Subject: 邮件主题
		message.setSubject("电子仓储管理系统", "UTF-8");

		// 5. Content: 邮件正文（可以使用html标签）

		message.setContent(s /*
								 * "弱智白露" +
								 * "<a href='http://localhost:8080/2/index.jsp'>点击验证</a>"
